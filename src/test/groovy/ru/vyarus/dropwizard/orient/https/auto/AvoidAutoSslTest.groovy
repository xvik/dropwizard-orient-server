 ...
 * @since 03.09.2017
 */
class AvoidAutoSslTest extends AbstractHttpsTest {

    @Rule
    DropwizardAppRule<TestConfiguration> RULE =
            new DropwizardAppRule<TestConfiguration>(TestApplication.class, 'src/test/resources/ru/vyarus/dropwizard/orient/https/auto/avoidAuto.yml');

    def "Check ssl auto not applied as ssl manual use detected"() {
