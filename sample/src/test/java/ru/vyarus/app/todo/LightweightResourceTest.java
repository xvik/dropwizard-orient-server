...
/**
 * Test does not start a real web context.
 *
 * @author Vyacheslav Rusakov
 * @since 11.09.2025
 */
@TestGuiceyApp(value = TodoApp.class, config = "src/test/resources/test-config.yml")
public class LightweightResourceTest extends AbstractTest {
